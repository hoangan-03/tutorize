  ...
  const transformQuizData = (formData: any): Partial<Quiz> => {
    ...
    const transformedData: Partial<Quiz> = {
      ...
      isAllowedViewAnswerAfterSubmit:
        !!extendedFormData.isAllowedViewAnswerAfterSubmit,
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden pt-8">
          {currentView === "create" && (
            <div>
              <div className="mb-6">
              ...
              <QuizFormTeacherView
                ...
                onSave={async (quizData) => {
                  ...
                  const createdQuiz = await createQuiz(transformedData);
                  // Let the QuizForm handle image uploads and then call handleBack
                  return createdQuiz;
                }}
              />
            </div>
