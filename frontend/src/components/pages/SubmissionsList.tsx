...
export const SubmissionsList: React.FC = () => {
  ...
  const getScoreDisplay = (score: number | null) => {
    if (score === null) return t("submissions.notGraded");
    ...
    <div className="mx-auto p-6 lg:px-16 xl:px-20">
      <div className="flex items-center justify-between mb-6">
        <h1 className="text-2xl font-bold">
          {isTeacher ? t("submissions.title") : t("submissions.mySubmissions")}
        </h1>
      </div>
      ...
      <div className="flex flex-col sm:flex-row gap-4 mb-6">
        <div className="flex items-center gap-2">
          ...
          >
            ...
            <option value="graded">{t("submissions.graded")}</option>
          </select>
        </div>
      ...
      {filteredSubmissions.length === 0 ? (
        <div className="text-center py-12">
          ...
          <p className="text-gray-500">
            {filter === "all"
              ? t("submissions.noSubmissionsDescription")
              : `${t("submissions.noSubmissionsDescription")} ${
                  filter === "submitted" ? t("submissions.submitted") : t("submissions.graded")
                }`}
          </p>
        </div>
      ) : (
                ...
                <div className="flex-1">
                  ...
                  <div className="flex items-center gap-6 text-sm text-gray-600">
                    ...
                    <div className="flex items-center gap-1">
                      ...
                      <span>
                        {t("submissions.submittedAt")}: {formatDateTime(submission.submittedAt)}
                      </span>
                    </div>
                  </div>
                  ...
                  {submission.status === SubmissionStatus.GRADED &&
                    submission.gradedAt && (
                      <div className="text-xs text-gray-500">
                        {t("submissions.gradedAt")}: {formatDateTime(submission.gradedAt)}
                      </div>
                    )}
                </div>
              </div>
      ...
      <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
          <div className="flex items-center gap-2 mb-2">
            ...
            <h4 className="font-medium text-blue-800">{t("submissions.totalSubmissions")}</h4>
          </div>
        ...
        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
          <div className="flex items-center gap-2 mb-2">
            ...
            <h4 className="font-medium text-yellow-800">{t("submissions.waitingGrade")}</h4>
          </div>
        ...
        <div className="bg-green-50 border border-green-200 rounded-lg p-4">
          <div className="flex items-center gap-2 mb-2">
            ...
            <h4 className="font-medium text-green-800">{t("submissions.completed")}</h4>
          </div>
